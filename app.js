...
const API_Key = "ADD_YOUR_HUGGINGFACE_API_KEY";    //Hugging face api key
...
const getImageDimentions = (aspectRatio, baseSize = 512) => {
    ...
    //Ensure dimenstions are multiple of 16 (Ai model requirements)
...
const updateImageCard = (imgIndex, imgurl) => {
    ...
    //Send request to huggingface API to create images
const generateImage = async (selectModel, imageCount, aspectRatio, promptText) => {
    ...
    const { width, height } = getImageDimentions(aspectRatio);
...
//fill prompt input by random example
